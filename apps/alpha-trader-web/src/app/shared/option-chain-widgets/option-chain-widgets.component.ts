  ...
  template: `
    @if (payload(); as oc) {
      <section class="widgets-grid">
        <article class="widget oi-balance">
          <header class="widget-head">
            <span class="widget-title">
              OI balance
              <button type="button" class="info-btn" (click)="openInfo($event, 'oiBalance')" aria-label="About OI balance">
        ...
        <article class="widget skew-vix">
          <header class="widget-head">
            <span class="widget-title">
              Volatility
              <button type="button" class="info-btn" (click)="openInfo($event, 'volatility')" aria-label="About volatility">
                <mat-icon>info_outline</mat-icon>
              </button>
            </span>
          </header>
        ...
        <article class="widget pain-widget">
          <header class="widget-head">
            <span class="widget-title">
              Max pain
              <button type="button" class="info-btn" (click)="openInfo($event, 'maxPain')" aria-label="About max pain">
                <mat-icon>info_outline</mat-icon>
              </button>
            </span>
          </header>
      ...
      @if (oc.atmGreeks; as greeks) {
        <section class="greeks-panel">
          <header class="greeks-head">
            <span class="widget-title">
              ATM Greeks
              <button type="button" class="info-btn" (click)="openInfo($event, 'atmGreeks')" aria-label="About ATM Greeks">
                <mat-icon>info_outline</mat-icon>
              </button>
            </span>
      ...
      @if (infoTopic(); as topic) {
        ...
        <aside class="detail-panel" role="dialog" [attr.aria-labelledby]="'widget-info-' + topic" (click)="$event.stopPropagation()">
...
export class OptionChainWidgetsComponent {
  ...
  openInfo(event: Event, topic: WidgetTopic): void {
